...
\section{Kvadratický spline}\label{mat:quad}

Kvadratický spline tvoří při interpolaci křivku, která je spojitá a spojitě diferencovatelná\cite{quad}. Stejně jako každý jiný spline zachovává hodnoty derivací v uzlu tak, aby byly stejné pro levý i pravý úsek, což zaručuje spojitou diferencovatelnost.
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{img/kondenzace.png}
